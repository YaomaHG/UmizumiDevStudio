...
const MINIJUEGO_SCENE = preload("res://scenes/minijuego_cocina.tscn")
...
func start_minigame():
	...
	minigame_instance.cocina_completada.connect(_on_minijuego_completado)
	minigame_instance.cocina_cancelada.connect(_on_minijuego_cancelado)
